...
export const getAllRegulations = async (dao) => {
  const daoContract = new web3.eth.Contract(daoAbi, dao);
  const increaseP = daoContract.getPastEvents('SupplyIncrease', { fromBlock: 1161506 });
  const decreaseP = daoContract.getPastEvents('SupplyDecrease', { fromBlock: 1161506 });
  const neutralP = daoContract.getPastEvents('SupplyNeutral', { fromBlock: 1161506 });
